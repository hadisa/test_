		...
		<div className="space-y-0.5">
			<label className="flex flex-col">
				...
				<input
					...
					{...props}
					className={clsx(
						"mt-0.5 w-full appearance-none rounded-md  border-neutral-300 shadow-sm transition-colors focus:border-neutral-300 focus:outline-none focus:ring focus:ring-neutral-200 focus:ring-opacity-50 active:border-neutral-200 active:outline-none text-gray-800",
