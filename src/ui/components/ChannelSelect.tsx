...
export const ChannelSelect = ({
	...
	return (
		<select
			className="h-10 w-fit rounded-md border border-neutral-300 dark:border-gray-500 bg-transparent bg-white px-4 py-2 pr-10 text-sm  placeholder:text-neutral-500 focus:border-black focus:ring-black"
			onChange={(e) => {
